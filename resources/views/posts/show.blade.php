<x-app-layout>
    ...
    <div class="container mx-auto mt-16 pb-12">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
                <!-- Adjust the max height of the image as needed -->
                <img src="/storage/{{$post->image}}" alt="Post Image" class="w-full max-h-100 object-cover">
                
            </div>
            <div class="bg-gray-200 p-6">
                <!-- Display the title and caption -->
                <h3 class="text-xl font-semibold mb-4">Title: {{ $post->user->username }}</h3>
                
                <p class="text-gray-700">Caption: {{ $post->caption }}</p>
